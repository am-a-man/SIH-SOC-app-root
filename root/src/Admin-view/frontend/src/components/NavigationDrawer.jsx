...
export default function NavigationDrawer(props) {
    ...
    const menuItems = [{ text: "VPN/Proxy Detector", path: "/", icon: <VpnIcon /> },
        { text: "Database", path: "/db", icon: <AnalyticsIcon /> }];
    //  { text: "Whois Fetch", path: "/whois", icon: <WhoisIcon /> },
    //   { text: "Advance Scan", path: "/advancesearch", icon: <AdvanceSearchIcon /> },
    //    { text: "Analytics", path: "/analytics", icon: <AnalyticsIcon /> },
    //     { text: "Batch Processes", path: "/batchprocess", icon: <BatchProcessIcon /> }];
            ...
            <AppBar position="fixed" className={classes.appBar}>
                <Toolbar>
                    ...
                    <Typography variant="h6" noWrap>
                        SOC App  - {title ? title : "Admin View"}
                    </Typography>
                </Toolbar>
            </AppBar>
